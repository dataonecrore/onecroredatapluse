...
function Campaigns({ demoMode = false, onAddCustomer, onImportCustomers }) {
      ...
      <main className="dashboard-main lg:pl-64">
        ...
        <div className="dashboard-content p-4 sm:p-6 lg:p-8">
          {activeView === "Import Customers" && isAdmin ? (
            ...
            <Campaigns demoMode={demoMode} onAddCustomer={openAddCustomer} onImportCustomers={() => selectView("Import Customers")} />
