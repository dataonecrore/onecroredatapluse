...
phone and email so separate customers who share contact details are preserved.
Phone and email remain fallback duplicate keys for rows without a Voter ID.
